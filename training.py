...
model.add(layers.Dense(1000 , input_dim=8 ,kernel_initializer='random_uniform', input_shape=Input_shape,activation='relu')) # input leyers 
...
model.fit(x_train, y_train, epochs = 1000, batch_size=1000, validation_data=(x_test, y_test))
...
if round(output[1]) == 1:
    ...
    print("==> The patient dosen't have diabetes")
print("outcome is : "+str(output[1]))       
# %%
